...
import com.google.ai.sample.settings.SettingItem;
import com.google.ai.sample.settings.SettingListAdapter;
...
public class SettingsActivity extends BaseActivity {
    ...
    private static final Settings asrLongSettings;
    ...
    static {
        ...
        asrSettings.register(Arrays.asList(
                ...
                new SettingItem(SettingItem.Type.BOOL, R.string.config_asr_auto_stop, false, R.string.no_hint),
        ...
        // Asr long settings
        asrLongSettings = new Settings();
        asrLongSettings.register(Arrays.asList(
                // common
                new SettingItem(SettingItem.Type.GROUP, R.string.common_setting_title, null, R.string.no_hint),
                new SettingItem(SettingItem.Type.STRING, R.string.config_app_id, SensitiveDefines.APPID, R.string.app_id_setting_hint),
                new SettingItem(SettingItem.Type.STRING, R.string.config_token, SensitiveDefines.TOKEN, R.string.token_setting_hint),
        ...
        ttsSettings.register(Arrays.asList(
            ...
            new SettingItem(SettingItem.Type.STRING, R.string.config_license_name, SensitiveDefines.LICENSE_NAME, R.string.tts_license_name_hint),
            new SettingItem(SettingItem.Type.STRING, R.string.config_license_busi_id, SensitiveDefines.LICENSE_BUSI_ID, R.string.tts_license_busi_id_hint),
    ...
    public static Settings getSettings(String viewId) {
        switch (viewId) {
            case SpeechDemoDefines.ASR_VIEW:
                return asrSettings;
            case SpeechDemoDefines.ASR_LONG_VIEW:
                return asrLongSettings;
